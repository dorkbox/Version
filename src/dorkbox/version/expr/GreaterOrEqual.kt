...
class GreaterOrEqual(
     ...
     *
     * @param version the version to compare to, the left-hand operand of the "greater than or equal to" operator
     *
     * @return `true` if the version is greater than or equal to the parsed version or `false` otherwise
     */

...
/**
 * The `MetadataVersion` class is used to represent
 ...
 */(
...
) : Comparable<MetadataVersion>, Serializable {
    /**
     * The implementation of the Null Object design pattern.
     */
    private class NullMetadataVersion
    /**
     * Constructs a `NullMetadataVersion` instance.
     */
    ...
    private fun compareIdentifierArrays(otherIdents: Array<String>?): Int {
        var result = 0
        val length = getLeastCommonArrayLength(idents, otherIdents)
    ...
    override fun compareTo(other: MetadataVersion): Int {
        ...
        var result = compareIdentifierArrays(other.idents)
        if (result == 0) {
            /**
             ...
             */
            result = idents!!.size - other.idents!!.size
        }
        return result
    }
